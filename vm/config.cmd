...
REM or 03 ??
call %BASE%\windows\config-x86-mingw-20.cmd
...
REM dlfcn
rem SET C_INCLUDE_PATH=%C_INCLUDE_PATH%;%DEPS_BASE%\dlfcn\include
rem SET CPLUS_INCLUDE_PATH=%CPLUS_INCLUDE_PATH%;%DEPS_BASE%\dlfcn\include
rem SET LD_LIBRARY_PATH=%LD_LIBRARY_PATH%;%DEPS_BASE%\dlfcn\lib
