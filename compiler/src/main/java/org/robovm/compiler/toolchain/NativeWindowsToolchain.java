...
public class NativeWindowsToolchain extends Toolchain {

    public NativeWindowsToolchain(Config config, Arch arch, OS os) {
    ...
    public void writeObjectFiles(File objectsFile, List<File> objectFiles)
        ...
        try {
            ...
            for (File f : objectFiles) {
                objectsOut.write('"');
                objectsOut.write(f.getAbsolutePath().replace("\\", "\\\\")
                        .getBytes());
                objectsOut.write('"');
                objectsOut.write('\n');
            }
    ...
    public String getGccpPath() {
        ...
        String ccPath = toolchainPath + "\\bin\\clang";
        return ccPath;
    }
    ...
    public void linkAbstract(List<File> objectFiles) throws IOException {
        ...
        String toolchainPath = getGccpPath();
